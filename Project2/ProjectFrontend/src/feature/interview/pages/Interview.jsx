                    ...
                    {activeNav === 'roadmap' && (
                        <section>
                            <div className='content-header'>
                                ...
                                {/* Schema ke exact "preperationPlan" naam ko target kiya gaya hai */}
                                <span className='content-header__count'>{(report?.preperationPlan?.length || 0)}-day plan</span>
                            </div>
                            <div className='roadmap-list'>
                                {report?.preperationPlan?.map((day, i) => (
                ...
                <aside className='interview-sidebar'>
                    ...
                    <div className='skill-gaps'>
                        ...
                        <div className='skill-gaps__list'>
                            {/* Schema ke exact "skillGap" naam ko target kiya gaya hai */}
